...
> **Version Reference**: This guide is written for **Proxmox VE 8.3/8.4** (based on Debian 12 "Bookworm"). The script is regularly maintained by the community and works across multiple Proxmox versions.
